...
<script type="text/javascript" src="http://code.jquery.com/jquery-1.11.3.js"></script>
	<script>
		...
		$(document).on('click', '#insertReply', function(){
			...
			var paramData = JSON.stringify({"reply_content":replyContent, "reply_writter": replyWritter, "board_num":'${boardDetail.board_num}'});
			var headers = {"Content-Type" : "application/json", "X-HTTP-Method-Override" : "POST"};
	...
	<article>
		<div class="container" role="main">
			...
			<c:set var="login_name"  value="${sessionId }" />
   				<c:if test="${boardDetail.board_writter eq sessionId}">
